        ...
        magicLink({
            ...
            <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                ...
                <table width="560" cellpadding="0" cellspacing="0" role="presentation" style="max-width:560px;width:100%;background:#ffffff;border:1px solid #2a2000;">
                    <tr>
                    <td style="background:#1a1200;padding:28px 40px;border-bottom:2px solid #c9960c;">
                        <table cellpadding="0" cellspacing="0" role="presentation">
                        <tr>
                            <td style="background:#c9960c;width:32px;height:32px;text-align:center;vertical-align:middle;">
                            <span style="font-size:18px;color:#1a1200;">★</span>
                            </td>
                            <td style="padding-left:10px;font-size:13px;font-weight:bold;color:#e8b820;letter-spacing:0.1em;">
                    ...
                    <td style="padding:40px 40px 32px;">
                        ...
                        <span style="color:#c9960c;word-break:break-all;">${url}</span>
                        </p>
                    </td>
                    </tr>
                    <tr>

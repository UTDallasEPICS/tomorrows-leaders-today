...
import GrantStatusWrapper from '../components/GrantStatusWrapper';
              ...
              <tbody>
                {formatted.map((grant, idx: number) => (
                  <tr key={idx} className="border-t">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap"><GrantStatusWrapper grantId={grant['id'] ?? 0} currentStatus={grant['status']} /></td>
